...
IF NOT EXISTS (SELECT * FROM [dbo].[Question])
    BEGIN
		SET IDENTITY_INSERT [dbo].[Question] ON
			...
			(4, 1, 2, N'Are you prepared to move to another area of the country for a role?',N'',N'',N'Select if you would move to another area of the country for an apprenticeship', null, 4, 1, CAST(N'2024-01-17T09:49:39.977' AS DateTime)),
