...
IF NOT EXISTS (SELECT * FROM [dbo].[Question])
	...
	(3, 1, 2, N'Are you prepared to move to another area of the country for a role?',N'',N'Working in other areas of the country',N'Select if you would move to another area of England for an apprenticeship', null, 3, 1, CAST(N'2024-01-17T09:49:39.977' AS DateTime),1, 'Education and Preferences'),
