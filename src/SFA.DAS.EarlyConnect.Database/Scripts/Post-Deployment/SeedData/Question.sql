...
IF NOT EXISTS (SELECT * FROM [dbo].[Question])
	...
	(2, 1, 1, N'Have you applied for any of the following?',N'This includes current and past applications. Select all that apply.',N'Where you''ve applied to stay in education',N'Select options you have applied for, or select ''None of the above''', 8, 2, 1, CAST(N'2024-01-17T09:49:39.977' AS DateTime),1, 'Education and Preferences'),
	(3, 1, 2, N'Would you move to another area of England for an apprenticeship?',N'',N'Would move to another area in England',N'Select if you would move to another area of England for an apprenticeship', null, 3, 1, CAST(N'2024-01-17T09:49:39.977' AS DateTime),1, 'Education and Preferences'),
